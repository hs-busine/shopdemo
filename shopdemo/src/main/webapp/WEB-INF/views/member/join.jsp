...
<div class="container">
  ...
  <div class="mb-3">
    <form>
      <!-- .row class 사용 = 총 길이의 합이 12가 나오도록 설정. -->
	  <div class="form-group row">
	    <label for="staticEmail" class="col-sm-2 col-form-label">아이디</label>
	    <div class="col-sm-5">
	      <input type="text" class="form-control" id="staticEmail" placeholder="아이디를 8~15자 이내로 입력하세요.">
	    </div>
	    <div class="col-sm-3">
	      <button type="button" class="btn btn-link">아이디 중복체크</button>
	    </div>
	    <label for="staticEmail" class="col-sm-2 col-form-label">중복체크 결과</label>
	  </div>
	  <div class="form-group row">
	  ...
	  <div class="form-group row">
		...
		<div class="col-sm-10 text-left pl-10">
